...
// v31: '무엇을' 회상 줄(자주 먹는 것 칩 + 타이핑 자동완성) 추가 +
//      제안 줄을 형태 값 표시자로 승격('다른 구분' 입구, 그리드 선택 반영).
//      회상 줄은 분류행 아래에 두고, 타이핑이 멎으면 스스로 닫힌다.
// index.html 구조가 바뀌었으므로 캐시 세대를 올린다.
const CACHE_NAME = 'mealog-v31';
/*
