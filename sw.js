...
// v44: 메모 기록 시트의 시각 칸이 끼니와 같은 껍데기로 바뀐다.
// v45: 메모 기록 시트 — 사진 칸이 위로 오고 편집·비율·순서 버튼이 붙는다.
// v46: 메모 기록 시트를 끼니 시트의 디자인 시스템 안으로 — 필드 구조가 바뀐다.
// v47: 메모 설정 — 새 항목 줄 아래에 아이콘 안내 한 줄이 붙는다.
// v48: 메모 설정 — '만들기' 버튼 워딩이 '추가'로 바뀐다.
const CACHE_NAME = 'mealog-v48';
/*
