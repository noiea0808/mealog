...
window.confirmDeletePhoto = async function() {
    ...
    try {
        ...
        successDiv.className = 'fixed top-4 right-4 bg-emerald-600 text-white px-6 py-3 rounded-xl shadow-lg z-[var(--z-admin-modal)] flex items-center gap-2';
...
function initAdminPage() {
    ...
    // 로그인 배너 UI (목록·작성은 login-banner.js)
