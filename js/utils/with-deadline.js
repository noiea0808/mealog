...
export const DEADLINE = {
    ...
    PREFLIGHT: 2000,
    /**
     * App Check 제공자(reCAPTCHA 실행 + 토큰 교환) 한 번.
     *
     * PREFLIGHT(2초)보다 훨씬 길다. 이건 호출부가 기다려 주는 시간이 아니라
     * **SDK 내부가 기다리는 것을 대신 끊어 주는** 상한이기 때문이다 — 여기서 인색하게 굴면
     * 느리지만 멀쩡한 회선에서 정상 토큰을 버리고 더미를 쓰게 된다. 목적은 빨리 끝내는 것이
     * 아니라 **반드시 끝나게 하는 것**이다.
     */
    APPCHECK: 10000,
    /** 단일 문서 읽기·쓰기 */
